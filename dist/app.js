...
(() => {
  ...
  // src/player-engine/image-renderer.ts
  var ImageRenderer;
  var init_image_renderer = __esm({
    "src/player-engine/image-renderer.ts"() {
      "use strict";
      ImageRenderer = class {
        render(container, item) {
          return new Promise((resolve, reject) => {
            var _a;
            var duration = (_a = item.duration) != null ? _a : 5e3;
            container.innerHTML = "";
            ...
            img.onerror = function() {
              container.innerHTML = "<div class='screen'><h1>Image Load Failed</h1><p>" + item.url + "</p></div>";
  ...
  // src/player-engine/video-renderer.ts
  var VideoRenderer;
  var init_video_renderer = __esm({
    "src/player-engine/video-renderer.ts"() {
      "use strict";
      VideoRenderer = class {
        render(container, item) {
          return new Promise((resolve, reject) => {
            ...
            video.onerror = function() {
              container.innerHTML = "<div class='screen'><h1>Video Load Failed</h1><p>" + item.url + "</p></div>";
            ...
            if (playPromise && typeof playPromise.then === "function") {
              playPromise.catch(function(error) {
                ...
                container.innerHTML = "<div class='screen'><h1>Video Play Failed</h1><p>" + item.url + "</p></div>";
                resolve();
              });
            }
          });
  ...
  // src/player-engine/renderer-factory.ts
  var RendererFactory;
  var init_renderer_factory = __esm({
    "src/player-engine/renderer-factory.ts"() {
      "use strict";
      init_image_renderer();
      init_video_renderer();
  ...
  // src/player-engine/player-engine.ts
  var PlayerEngine;
  var init_player_engine = __esm({
    "src/player-engine/player-engine.ts"() {
      "use strict";
      init_renderer_factory();
      PlayerEngine = class {
        ...
        playPlaylist(playlist) {
          if (!playlist.items.length) {
            this.container.innerHTML = "<div class='screen'><h1>No media found</h1></div>";
        ...
        renderLoop(playlist, token) {
          ...
          return renderer.render(this.container, item).catch(function(error) {
  ...
  var PlaybackService;
  var init_playback_service = __esm({
    "src/services/playback-service.ts"() {
      "use strict";
      init_player_engine();
      PlaybackService = class {
        ...
        start(playlist) {
          ...
          this.isPaused = false;
          this.logger.info("PLAYER", "Playback started", { count: playlist.items.length });
        ...
        onVisible() {
          ...
          if (this.isPaused) {
            this.logger.info("PLAYER", "Resume skipped because player is paused by command");
            return Promise.resolve();
          }
          return this.playerEngine.playPlaylist(this.currentPlaylist);
        }
  ...
  // src/network-layer/playlist-api.ts
  var PlaylistApi;
  var init_playlist_api = __esm({
    "src/network-layer/playlist-api.ts"() {
      "use strict";
      init_config();
      PlaylistApi = class {
        ...
        fetchPlaylist() {
          ...
          return this.apiClient.get(config.playlistEndpointUrl).then(function(response) {
            var _a;
            return {
              version: (_a = response.version) != null ? _a : "1.0.0",
              hash: response.hash,
              items: response.playlist.map(function(item, index) {
                return {
                  id: "media-" + index,
                  type: item.type,
                  url: item.url,
                  duration: item.type === "image" && typeof item.duration === "number" ? item.duration * 1e3 : void 0
                };
              })
            };
          });
  ...
  // src/network-layer/api-client.ts
  var ApiClient;
  ...
  // src/storage-layer/playlist-cache.ts
  var PlaylistCache;
  var init_playlist_cache = __esm({
    "src/storage-layer/playlist-cache.ts"() {
      "use strict";
      PlaylistCache = class {
        constructor(storage) {
        ...
        savePlaylist(playlist) {
          ...
          return this.storage.setItem(this.key, JSON.stringify(envelope)).then(function() {
  ...
  // src/storage-layer/storage.ts
  var LocalStorageLayer;
  var init_storage = __esm({
    "src/storage-layer/storage.ts"() {
      "use strict";
      LocalStorageLayer = class {
        getItem(key) {
  ...
  var PlaylistService;
  var init_playlist_service = __esm({
    "src/services/playlist-service.ts"() {
      "use strict";
      init_playlist_api();
      init_api_client();
      ...
      PlaylistService = class {
        ...
        getPlaylist() {
          ...
          return this.playlistApi.fetchPlaylist().then(function(networkPlaylist) {
            console.log("[PlaylistService] Network playlist loaded successfully");
            return _this.playlistCache.getPlaylist().then(function(cachedPlaylist) {
              ...
              return _this.playlistCache.savePlaylist(networkPlaylist).then(function() {
            ...
            return _this.playlistCache.getPlaylist().then(function(cachedPlaylist) {
              ...
              throw new Error(
                "No playlist available from network or cache. Network error: " + (networkError instanceof Error ? networkError.message : "unknown")
              );
            });
          });
        }
        hasPlaylistChanged(cachedPlaylist, incomingPlaylist) {
          if (!cachedPlaylist) {
            return true;
          }
  ...
  var init_command_service = __esm({
    "src/services/command-service.ts"() {
      ...
      CommandService = class {
        constructor(platform, logger, actions) {
        ...
        handleSetVolume(command) {
          var payload = command.payload;
          var value = payload ? payload.value : void 0;
          ...
          return this.platform.setVolume(value).then(() => {
            return this.success(command.command, command.correlationId, { value });
          });
        }
        ...
        success(command, correlationId, payload) {
          return {
            type: "command_result",
            command,
            correlationId,
...
`) && (e = e.replace(Kx, "%0A")), e.includes("\r") && (e = e.replace(Qx, "%0D")), e.includes("	") && (e = e.replace(Yx, "%09")), n.pathname = e, n;
  ...
  var as, Yb, Jb, Xb, ze, D, Kr, Zb, me, A, M, Mt, Qr, wr, Pi, lc, cc, fc, hc, dc, pc, yc, gc, bc, wc, mc, _c, vc, Sc, Ec, Ac, Ic, Tc, Pc, Oc, Bc, Mc, Ri, Nc, qc, Lc, Uc, Dc, jc, Wc, $c, Hc, Gc, zc, Kc, Qc, Yc, Jc, Xc, Zc, ef, tf, rf, nf, of, sf, af, uf, Jt, us, ls, cf, ff, hf, df, pf, yf, gf, bf, wf, mf, _f, Sf, Ef, I, On, Af, ki, If, mr, xf, Pf, qe, Xt, U, nw, iw, ke, x, Ee, hs, De, Yr, Zt, Ni, Nf, Rn, gw, bw, ww, mw, _w, vw, er, $e, Xr, tr, mt, Ut, Ar, $i, kn, Dh, Cn, Gh, Qh, Us, Nn, ro, Hd, St, oa, aa, so, wa, wp, Sa, Ea, or, Op, Cp, Bp, Np, Pa, Up, jp, At, $p, zp, Kp, Ba, oy, sy, uy, cy, Na, Ua, dy, py, Mr, zn, by, Sy, It, Ey, Ay, Iy, xo, xt, eu, xy, Ty, Py, Oy, su, uu, By, Ny, hu, gu, Uy, jy, Fy, $y, mu, Vy, Gy, zy, Ky, Iu, Qy, Yy, Xn, Xy, Zy, eg, tg, rg, ng, og, sg, ag, Ou, cg, Ru, ku, Cu, Nu, qu, hg, dg, pg, gg, wg, _g, Sg, Ag, yi, Rg, ju, zo, qg, Gu, Lg, hr, w5, m5, _5, v5, S5, E5, Ug, zu, Dg, Ku, jg, Qu, Fg, Yu, Wg, Ju, $g, Xu, Hg, Zu, Vg, el, Gg, tl, zg, rl, Kg, nl, Qg, il, Yg, ol, Jg, sl, Xg, al, Zg, ul, eb, ll, tb, cl, rb, fl, nb, wi, ib, hl, ob, lb, zt, En, $r, Ko, pI, yI, gI, bI, wI, mI, _I, vI, SI, EI, AI, II, xI, TI, PI, OI, kI, CI, BI, LI, UI, ml, DI, jI, FI, WI, $I, HI, GI, zI, KI, YI, JI, XI, ZI, ex, tx, rx, nx, ix, ox, sx, ax, ux, lx, cx, fx, dr, yl, gl, dx, px, yx, gx, bx, mx, _x, vx, Sx, Ex, Ax, _l, vl, Sl, hb, El, db, Ib, Tx, Al, pb, Il, xl, yb, Tl, gb, Pl, bb, Ol, wb, Rl, mb, kl, _b, Hr, vb, Ge, Mx, Nx, qx, Lx, Ux, Dx, jx, Fx, Wx, $x, Hx, Cl, Vx, Gx, zx, Kx, Qx, Yx, xb, Pb, Qo, _i, Ll, lT, Ul, Dl, Fl, Nb, yT, qb, $l, Gl, Ql, $b, Jl, XT, mqtt_esm_default;
  var init_mqtt_esm = __esm({
    "node_modules/mqtt/dist/mqtt.esm.js"() {
      ...
      ze = (t, e) => () => (t && (e = t(t = 0)), e);
      D = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
      Kr = (t, e) => {
      ...
      me = (t) => Zb(as({}, "__esModule", { value: true }), t);
      A = ze(() => {
      });
      M = {};
...
`;
      ...
      so = D((nB, rp) => {
        ...
        async function no(t, e, r, { end: n }) {
          ...
          try {
            ...
            try {
              for (var iter = __forAwait(t), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
                let f = temp.value;
                e.write(f) || await a();
              }
            } catch (temp) {
      ...
      wp = D((EB, va) => {
        ...
        function co(t, e) {
          ...
          let n = r - 1;
          return (e == null ? void 0 : e.highWaterMark) != null && (n = cp(e.highWaterMark)), lp(r, "options.concurrency", 1), lp(n, "options.highWaterMark", 0), n += r, function() {
            return __asyncGenerator(this, null, function* () {
              ...
              async function b() {
                try {
                  try {
                    for (var iter = __forAwait(o), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
                      let m = temp.value;
                      if (d) return;
              ...
              try {
                for (; ; ) {
                  for (; a.length > 0; ) {
                    let m = yield new __await(a[0]);
                    if (m === pp) return;
                    if (s.aborted) throw new Et();
                    m !== lo && (yield m), a.shift(), E();
                  }
                  yield new __await(new fp((m) => {
                    f = m;
                  }));
                }
              } finally {
        ...
        function uS(t = void 0) {
          return t != null && kr(t, "options"), (t == null ? void 0 : t.signal) != null && Rr(t.signal, "options.signal"), function() {
            return __asyncGenerator(this, null, function* () {
              let r = 0;
              try {
        ...
        async function gp(t, e = void 0) {
          try {
            for (var iter = __forAwait(_a.call(this, t, e)), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
              let r = temp.value;
              return true;
            }
          } catch (temp) {
        ...
        async function fS(t, e) {
          ...
          try {
            for (var iter = __forAwait(co.call(this, r, e)), more, temp, error; more = !(temp = await iter.next()).done; more = false) {
              let n = temp.value;
              ;
            }
          } catch (temp) {
        ...
        function yS(t, e = void 0) {
          return e != null && kr(e, "options"), (e == null ? void 0 : e.signal) != null && Rr(e.signal, "options.signal"), t = bp(t), function() {
            return __asyncGenerator(this, null, function* () {
              var n;
      ...
      Mr = D((ht) => {
        ...
        function kE(t, e, r = false) {
          ...
          for (let i of n) for (let s of Object.getOwnPropertyNames(i.prototype)) (r || s !== "constructor") && Object.defineProperty(t.prototype, s, (_a = Object.getOwnPropertyDescriptor(i.prototype, s)) != null ? _a : /* @__PURE__ */ Object.create(null));
        }
        ...
        var NE = (t) => !my.has(t), yL = Symbol("type"), lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), vy = (t) => lr(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? bn : null : null, bn = class extends Array {
          ...
          *rvalues() {
          ...
          memo(e, r = {}) {
            ...
            let _a3 = r, { context: i, forceRefresh: s } = _a3, o = __objRest(_a3, ["context", "forceRefresh"]), a = this.get(e, o);
          ...
          return r === void 0 ? (this.set(e, P, __spreadProps(__spreadValues({}, c.options), { status: void 0 })), r = __privateGet(this, _n).get(e)) : __privateGet(this, _e)[r] = P, P;
        }, t_fn = function(e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      zo = D((yt) => {
        ...
        var Fu = fr(sy()), $A = or(), kg = fr(cy()), HA = fr(At()), Cg = Ng(Na()), vn = fr(Ua()), VA = fr(Ky()), GA = fr(Iu()), zA = fr(Qy()), bi = Mr(), KA = Yy(), QA = fr(ju()), Bg = Ng(yi()), Wu = globalThis.setImmediate || ((...t) => {
          ...
          connect() {
            ...
            if (this.options.will && (c.will = __spreadProps(__spreadValues({}, this.options.will), { payload: (_a2 = this.options.will) == null ? void 0 : _a2.payload })), this.topicAliasRecv && (c.properties || (c.properties = {}), this.topicAliasRecv && (c.properties.topicAliasMaximum = this.topicAliasRecv.max)), this._writePacket(c), r.on("error", this.emit.bind(this, "error")), this.options.properties) {
          ...
          subscribe(e, r, n) {
            ...
            let w = (P, E) => {
              ...
              var _a2;
              let P = (_a2 = this.options.subscribeBatchSize) != null ? _a2 : h.length, E = [];
  ...
  // src/mqtt-layer/mqtt-client.ts
  var RealMqttClient;
  var init_mqtt_client = __esm({
    "src/mqtt-layer/mqtt-client.ts"() {
      "use strict";
      init_mqtt_esm();
      RealMqttClient = class {
        constructor(options) {
        ...
        connect() {
          ...
          return new Promise(function(resolve, reject) {
            _this.client = mqtt_esm_default.connect(_this.options.brokerUrl, {
  ...
  // src/mqtt-layer/mqtt-parser.ts
  function isValidCommandType(value) {
    return value === "reload_playlist" || value === "restart_player" || value === "play" || value === "pause" || value === "set_volume" || value === "screenshot";
  }
  var MqttParser;
  var init_mqtt_parser = __esm({
    "src/mqtt-layer/mqtt-parser.ts"() {
      "use strict";
      MqttParser = class {
        parseCommand(raw) {
          ...
          if (typeof commandData.command !== "string" || !isValidCommandType(commandData.command)) {
            throw new Error("INVALID_COMMAND_TYPE");
          }
          if (typeof commandData.correlationId !== "string" || !commandData.correlationId) {
  ...
  // src/mqtt-layer/mqtt-topics.ts
  var MqttTopics;
  var init_mqtt_topics = __esm({
    "src/mqtt-layer/mqtt-topics.ts"() {
      "use strict";
      MqttTopics = class {
        static commandTopic(deviceId) {
          return "players/" + deviceId + "/commands";
        }
        static eventTopic(deviceId) {
  ...
  var AppService;
  var init_app_service = __esm({
    "src/services/app-service.ts"() {
      "use strict";
      init_config();
      init_playback_service();
      init_playlist_service();
      ...
      AppService = class {
        ...
        start() {
          ...
          var app = appElement;
          return this.platform.init().then(function() {
            ...
            app.innerHTML = "<div class='screen'><h1>Playback Failed</h1><p>" + (error instanceof Error ? error.message : "Playlist y\xFCklenemedi.") + "</p></div>";
          });
        }
        bindLifecycle() {
          var _this = this;
          if (this.platform.onVisibilityChange) {
            this.platform.onVisibilityChange(function(visible) {
              ...
              if (visible) {
                _this.playbackService.onVisible().catch(function(error) {
            ...
            reloadPlaylist: function() {
              ...
              return _this.playlistService.getPlaylist().then(function(result) {
                ...
                if (!result.changed && result.source === "network") {
                  _this.logger.info("PLAYLIST", "Reload skipped because playlist is unchanged");
                  return Promise.resolve();
                }
        ...
        handleSoftRestart(command, mqttClient, deviceId) {
          var _this = this;
          ...
          this.playbackService.restart().then(function() {
            return mqttClient.publish(
              MqttTopics.eventTopic(deviceId),
              JSON.stringify({
                type: "command_result",
      ...
      Logger = class {
        ...
        write(level, module, message, meta) {
          ...
          this.transports.forEach(function(transport) {
            transport.send(entry).catch(function(error) {
  ...
  // src/infrastructure/log-transport.ts
  var ConsoleTransport, MockRemoteTransport;
  var init_log_transport = __esm({
    "src/infrastructure/log-transport.ts"() {
      "use strict";
      ConsoleTransport = class {
        send(entry) {
          var _a, _b2, _c2;
          var prefix = "[" + entry.timestamp + "] [" + entry.level.toUpperCase() + "] [" + entry.module + "]";
          if (entry.level === "error") {
            console.error(prefix, entry.message, (_a = entry.meta) != null ? _a : "");
          } else if (entry.level === "warn") {
            console.warn(prefix, entry.message, (_b2 = entry.meta) != null ? _b2 : "");
          } else {
            console.log(prefix, entry.message, (_c2 = entry.meta) != null ? _c2 : "");
          }
          return Promise.resolve();
        }
      };
      MockRemoteTransport = class {
  ...
  // src/platform-adapter/browser-adapter.ts
  var BrowserAdapter;
  var init_browser_adapter = __esm({
    "src/platform-adapter/browser-adapter.ts"() {
      "use strict";
  ...
  // src/platform-adapter/tizen-adapter.ts
  var TizenAdapter;
  var init_tizen_adapter = __esm({
    "src/platform-adapter/tizen-adapter.ts"() {
      "use strict";
      TizenAdapter = class {
        constructor() {
  ...
  var require_index = __commonJS({
    "src/index.ts"() {
      ...
      function writeScreen(text) {
        ...
        if (app) {
          app.innerHTML = "<div style='width:100vw;height:100vh;background:black;color:white;display:flex;align-items:center;justify-content:center;font-family:Arial,sans-serif;flex-direction:column;padding:20px;text-align:center;'>" + text + "</div>";
        }
      }
      ...
      function resolvePlatform() {
        var isTizen = typeof window !== "undefined" && typeof window.tizen !== "undefined";
        if (isTizen) {
